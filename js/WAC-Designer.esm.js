...
let AssetsBase = 'https://rozek.github.io/webapp-crafter/';
...
function generatedEmbeddableAppletFromWidget(BaseWidget) {
    if (BaseWidget == null) {
...
function generatedStandaloneAppletFromWidget(BaseWidget) {
    if (BaseWidget == null) {
        window.alert('No Widget selected');
        return;
    }
...
function doExport(Scope) {
    ...
    switch (Scope) {
        ...
        case 'selected Pages':
            ...
            suggestedFileName = (((_a = Pages[0]) === null || _a === void 0 ? void 0 : _a.Name) || 'WAC-Page') + '.json';
            break;
        case 'selected Widgets':
            const Widgets = DesignerState.selectedWidgets;
            Serialization = Widgets.map((Widget) => Widget.Serialization);
            suggestedFileName = (((_b = Widgets[0]) === null || _b === void 0 ? void 0 : _b.Name) || 'WAC-Widgets') + '.json';
            break;
        case 'Applet Design':
            Serialization = Applet.Serialization;
    ...
    window.requestAnimationFrame(async () => {
        ...
        try {
            ...
            const Name = (VisualToRender === Applet
                ? ((_a = Applet.visitedBoard) === null || _a === void 0 ? void 0 : _a.Name) || Applet.Name || 'WAC-Applet'
     ...
     <${WAD_vertically} style="width:100%; height:100%; padding:4px">
      ...
      <${WAD_horizontally} style="padding-top:4px; padding-bottom:4px">
        ...
        <${WAD_TextlineInput} Placeholder="(behavior name)" style="flex:1 0 auto"
          ...
          onInput=${(Event) => { Inspector.newBehaviorName = Event.target.value; WAC_rerender(); }}
        />
          <div style="width:8px"/>
      ...
      " ref=${scrollablePane} scrollTop=${ScrollPosition} onScroll=${updateScrollPosition}>
        ...
        doConfigureApplet('BackgroundTexture', {
          ...
          <${WAD_horizontally}>
            ...
            <${WAD_Gap}/>
            <${WAD_DropDown}
              Value=${(_g = Applet.BackgroundTexture) === null || _g === void 0 ? void 0 : _g.Mode} Options=${WAC_BackgroundModes}
              onInput=${(Event) => {
        const { isActive, ImageURL, Mode, xOffset, yOffset } = (Applet.BackgroundTexture || { isActive: false, ImageURL: '', Mode: 'tile', xOffset: 0, yOffset: 0 });
        doConfigureApplet('BackgroundTexture', {
      ...
      " ref=${scrollablePane} scrollTop=${ScrollPosition} onScroll=${updateScrollPosition}>
        ...
        doConfigureVisitedPage('BackgroundTexture', {
          ...
          <${WAD_horizontally}>
            ...
            <${WAD_Gap}/>
            <${WAD_DropDown}
              Value=${(_g = visitedPage.BackgroundTexture) === null || _g === void 0 ? void 0 : _g.Mode} Options=${WAC_BackgroundModes}
              onInput=${(Event) => {
        const { isActive, ImageURL, Mode, xOffset, yOffset } = (visitedPage.BackgroundTexture || { isActive: false, ImageURL: '', Mode: 'tile', xOffset: 0, yOffset: 0 });
        doConfigureVisitedPage('BackgroundTexture', {
            isActive, ImageURL, Mode: Event.target.value, xOffset, yOffset
